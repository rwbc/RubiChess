...
struct evalparamset {
    ...
    eval eIsolatedpawnpenalty[8] = {  VALUE( -10,  -5), VALUE( -11,  -5), VALUE( -18, -10), VALUE( -21, -12), VALUE( -25, -11), VALUE( -13, -10), VALUE(  -7,  -9), VALUE( -15,  -3)  };
    eval eDoublepawnpenalty[2] = {  VALUE( -11, -18), VALUE(  -4,  -8)  };
